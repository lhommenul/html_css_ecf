// ======== HEADER TEMPLATE ========
let source = "<div class='to_center'><a href='/' class='header_title_site'>DWWM</a><button id='hamburger_btn'>Menu</button><nav class='header_nav' aria-modal='true' aria-describedby='menu de navigation'><ul class='header_nav_list'><li class='header_list_items'><a class='header_nav_link' href='/'>ACCUEIL</a></li><li class='header_list_items'><a class='header_nav_link' href='/views/formation.html'>LA FORMATION</a></li><li class='header_list_items'><a class='header_nav_link' href='/views/student.html'>LES ETUDIANTS</a></li><li class='header_list_items'><a class='header_nav_link' href='/views/actu.html'>ACTUALITES</a></li><li class='header_list_items'><a class='header_nav_link' href='/views/contact.html'>NOUS CONTACTER</a></li></ul></nav></div>";
