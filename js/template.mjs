// ======== HEADER TEMPLATE ========
let source = "<div class='to_center'><p class='header_title_site'>DWWM</p><nav class='header_nav'><button class='btn_menu_header'><img src='./assets/home/icon/date.svg' alt='hamburger menu' aria-expanded='false'></button><ul class='header_nav_list'><li class='header_list_items'><a class='header_nav_link' href='/'>ACCUEIL</a></li><li class='header_list_items'><a class='header_nav_link' href='/views/formation.html'>LA FORMATION</a></li><li class='header_list_items'><a class='header_nav_link' href='/views/student.html'>LES ETUDIANTS</a></li><li class='header_list_items'><a class='header_nav_link' href='/views/actu.html'>ACTUALITES</a></li><li class='header_list_items'><a class='header_nav_link' href='/views/contact'>NOUS CONTACTER</a></li></ul></nav></div>";
